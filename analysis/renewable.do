...
gen ln_tc_solar = log(1+solar_tot_input_costs)
gen ln_tc_wind  = log(1+wind_tot_input_costs)
gen ln_tc_windsolar_diff = ln_tc_wind - ln_tc_solar
...
reg3 (ln_net_gen_solarwind_diff = ln_tc_windsolar_diff i.statefips) ///
   (ln_net_gen_solarwind_diff = ln_snge ln_wnge) ///
   (ln_snge = ln_epa ln_sar land_area) ///
   (ln_wnge = ln_epa avg_wind_speed land_area) ///
   , endog(ln_epa)
