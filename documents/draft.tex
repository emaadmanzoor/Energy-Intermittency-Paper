...
Firstly, note that we cannot observe the demand shifter $\alpha_{t,i}$ directly, so we add a set of controls that may be responsible for shifts in demand. Our regression is then
\begin{align*}
